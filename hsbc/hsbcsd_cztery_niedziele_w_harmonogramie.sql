...
FunkcjePrac AS (
    /*+ MATERIALIZE */
    -- KROK 2b: J_ORG i MPK obliczone raz na pracownika, nie raz na każdą niedzielę.
    SELECT DISTINCT
           prac_id,
           AKT_DANE.J_ORG(prac_id, SYSDATE) AS JO,
           AKT_DANE.MPK(prac_id, SYSDATE)   AS MPK
