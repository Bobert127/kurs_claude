...
-- Tylko zapłata pieniężna, okres rozliczeniowy, daty początku/końca okresu,
-- absencje w okresie (XMLAGG), filtr komunikatu, kolejny numer porządkowy (lp)
-- sortowany po polsku (nazwisko, imię)
...
WITH
  ...
  /*  6. Absencje w okresie rozliczeniowym (XMLAGG — brak limitu 4000 znaków)
        Powiązane z pracownikiem oraz początkiem i końcem okresu rozliczeniowego */
  absencje_cte AS (
      SELECT
             o.kali_id,
             o.prac_id,
      ...
      GROUP BY o.kali_id, o.prac_id, o.poczatek_okresu, o.koniec_okresu
  )
