...
BEGIN
    FOR rec IN c LOOP
        ...
        src_rec.classified_seconds_13 := src_rec.classified_seconds_13 / 2;
        src_rec.classified_seconds_14 := src_rec.classified_seconds_14 / 2;
        src_rec.classified_seconds_15 := src_rec.classified_seconds_15 / 2;
        src_rec.classified_seconds_16 := src_rec.classified_seconds_16 / 2;
        src_rec.classified_seconds_17 := src_rec.classified_seconds_17 / 2;
        src_rec.classified_seconds_18 := src_rec.classified_seconds_18 / 2;
        src_rec.classified_seconds_19 := src_rec.classified_seconds_19 / 2;
        ...
        src_rec.classified_seconds_22 := src_rec.classified_seconds_22 / 2;
        src_rec.classified_seconds_23 := src_rec.classified_seconds_23 / 2;
        src_rec.classified_seconds_24 := src_rec.classified_seconds_24 / 2;
        src_rec.classified_seconds_25 := src_rec.classified_seconds_25 / 2;
        src_rec.classified_seconds_26 := src_rec.classified_seconds_26 / 2;
        src_rec.classified_seconds_27 := src_rec.classified_seconds_27 / 2;
        src_rec.classified_seconds_28 := src_rec.classified_seconds_28 / 2;
        src_rec.classified_seconds_29 := src_rec.classified_seconds_29 / 2;
