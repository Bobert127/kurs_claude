...
(
        ...
        akt_dane.typ_pracownika(pracid, TO_DATE('01.06.2026', 'DD.MM.YYYY')) NAZWA_STANOWISKA,
        akt_dane.stanowisko(pracid, TO_DATE('01.06.2026', 'DD.MM.YYYY')) STANOWISKO,
        akt_dane.wym_et(pracid, TO_DATE('01.06.2026', 'DD.MM.YYYY')) ETAT,
        akt_dane.j_org(pracid, TO_DATE('01.06.2026', 'DD.MM.YYYY')) JEDN_ORG,
        ...
        where zo.calendar_date between '26/06/01' and '26/06/30'
...
union all
        ...
        akt_dane.typ_pracownika(p.prac_id, TO_DATE('01.06.2026', 'DD.MM.YYYY')) NAZWA_STANOWISKA,
        akt_dane.stanowisko(p.prac_id, TO_DATE('01.06.2026', 'DD.MM.YYYY')) STANOWISKO,
        akt_dane.wym_et(p.prac_id, TO_DATE('01.06.2026', 'DD.MM.YYYY')) ETAT,
        akt_dane.j_org(p.prac_id, TO_DATE('01.06.2026', 'DD.MM.YYYY')) JEDN_ORG,
        0 g50,
        0 g100,
        0 sred,
        0 g_ponadnormatywne,
